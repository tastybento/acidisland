...
public class IslandGuard implements Listener {
	...
	if (e.getPlayer().getWorld().getName().equalsIgnoreCase(Settings.worldName)) {
	    ...
	    if (VaultHelper.checkPerm(e.getPlayer(), "acidisland.mod.bypassprotect")) {
		return;
	    }
	...
	if (e.getDamager() instanceof Player) {
	    ...
	    // This permission bypasses protection
	    if (VaultHelper.checkPerm((Player)e.getDamager(), "acidisland.mod.bypassprotect")) {
		return;
	    }
	}
	...
	if (e.getEntity().getWorld().getName().equalsIgnoreCase(Settings.worldName)) {
		...
		if (e.getRemover() instanceof Player) {
		    ...
		    // This permission bypasses protection
		    if (VaultHelper.checkPerm(p, "acidisland.mod.bypassprotect")) {
			return;
		    }
