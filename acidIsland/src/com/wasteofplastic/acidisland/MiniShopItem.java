...
public class MiniShopItem {
    ...
    //private AcidIsland plugin = AcidIsland.getPlugin();
	...
	try {
		...
		if (!material.equals(Material.POTION)) {
			...
			//AcidIsland.getPlugin().getLogger().info("Potion in shop is :" + newPotion.getType().toString());
			break;
		    case 2:
			// Extended or splash potions
			if (extras[1].equalsIgnoreCase("EXTENDED")) {
			    newPotion = new Potion(PotionType.valueOf(extras[0])).extend();
			    //AcidIsland.getPlugin().getLogger().info("Potion in shop is :" + newPotion.getType().toString() + " extended duration");
			    newPotion.apply(item);
			} else if (extras[1].equalsIgnoreCase("SPLASH")) {
			    newPotion = new Potion(PotionType.valueOf(extras[0])).splash();
			    //AcidIsland.getPlugin().getLogger().info("Potion in shop is :" + newPotion.getType().toString() + " splash duration");
			    newPotion.apply(item);
			} else if (extras[1].equalsIgnoreCase("EXTENDEDSPLASH")) {
			    newPotion = new Potion(PotionType.valueOf(extras[0])).extend().splash();
			    //AcidIsland.getPlugin().getLogger().info("Potion in shop is :" + newPotion.getType().toString() + " extended duration splash");
			    newPotion.apply(item);
			}
		    }
		}
	    ...
	    AcidIsland.getPlugin().getLogger().info("Potions can also be EXTENDED, SPLASH or EXTENDEDSPLASH, example WATER_BREATHING:EXTENDED");
	}
